...
class ServiceResourceIT {
    ...
    private static final String DEFAULT_DISPONIBILITE = "AAAAAAAAAA";
    private static final String UPDATED_DISPONIBILITE = "BBBBBBBBBB";
    ...
    void partialUpdateServiceWithPatch() throws Exception {
        ...
        partialUpdatedService.disponibilite(UPDATED_DISPONIBILITE).typeService(UPDATED_TYPE_SERVICE);
