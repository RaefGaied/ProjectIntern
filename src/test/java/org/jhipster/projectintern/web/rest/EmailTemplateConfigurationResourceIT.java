...
class EmailTemplateConfigurationResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DATEDE_CREATION = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATEDE_CREATION = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final ZonedDateTime DEFAULT_DATEDE_MODIFICATION = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATEDE_MODIFICATION = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static EmailTemplateConfiguration createEntity(EntityManager em) {
        EmailTemplateConfiguration emailTemplateConfiguration = new EmailTemplateConfiguration()
            ...
            .corps(DEFAULT_CORPS)
            .datedeCreation(DEFAULT_DATEDE_CREATION)
            .datedeModification(DEFAULT_DATEDE_MODIFICATION)
    ...
    public static EmailTemplateConfiguration createUpdatedEntity(EntityManager em) {
        EmailTemplateConfiguration emailTemplateConfiguration = new EmailTemplateConfiguration()
            ...
            .corps(UPDATED_CORPS)
            .datedeCreation(UPDATED_DATEDE_CREATION)
            .datedeModification(UPDATED_DATEDE_MODIFICATION)
    ...
    void getAllEmailTemplateConfigurations() throws Exception {
        ...
        restEmailTemplateConfigurationMockMvc
            ...
            .andExpect(jsonPath("$.[*].datedeCreation").value(hasItem(sameInstant(DEFAULT_DATEDE_CREATION))))
            .andExpect(jsonPath("$.[*].datedeModification").value(hasItem(sameInstant(DEFAULT_DATEDE_MODIFICATION))))
    ...
    void getEmailTemplateConfiguration() throws Exception {
        ...
        restEmailTemplateConfigurationMockMvc
            ...
            .andExpect(jsonPath("$.datedeCreation").value(sameInstant(DEFAULT_DATEDE_CREATION)))
            .andExpect(jsonPath("$.datedeModification").value(sameInstant(DEFAULT_DATEDE_MODIFICATION)))
