...
class ReservationResourceIT {
    ...
    private static final Integer DEFAULT_NOMBRE_PERSONNES = 1;
    private static final Integer UPDATED_NOMBRE_PERSONNES = 2;
    ...
    public static Reservation createEntity(EntityManager em) {
        Reservation reservation = new Reservation()
            ...
            .nombrePersonnes(DEFAULT_NOMBRE_PERSONNES)
    ...
    public static Reservation createUpdatedEntity(EntityManager em) {
        Reservation reservation = new Reservation()
            ...
            .nombrePersonnes(UPDATED_NOMBRE_PERSONNES)
    ...
    void getAllReservations() throws Exception {
        ...
        restReservationMockMvc
            ...
            .andExpect(jsonPath("$.[*].nombrePersonnes").value(hasItem(DEFAULT_NOMBRE_PERSONNES)))
    ...
    void getReservation() throws Exception {
        ...
        restReservationMockMvc
            ...
            .andExpect(jsonPath("$.nombrePersonnes").value(DEFAULT_NOMBRE_PERSONNES))
    ...
    void partialUpdateReservationWithPatch() throws Exception {
        ...
        partialUpdatedReservation.dateDebut(UPDATED_DATE_DEBUT).dateFin(UPDATED_DATE_FIN).totalPrix(UPDATED_TOTAL_PRIX);
