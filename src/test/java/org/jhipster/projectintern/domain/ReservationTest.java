...
class ReservationTest {
    ...
    void paiementTest() {
        ...
        reservation.setPaiement(paiementBack);
        assertThat(reservation.getPaiement()).isEqualTo(paiementBack);
        assertThat(paiementBack.getReservation()).isEqualTo(reservation);

        reservation.paiement(null);
        assertThat(reservation.getPaiement()).isNull();
