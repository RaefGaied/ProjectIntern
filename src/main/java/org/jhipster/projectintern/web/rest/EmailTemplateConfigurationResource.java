...
public class EmailTemplateConfigurationResource {
    ...
    private final SecurityFilterChain filter;
    ...
    public EmailTemplateConfigurationResource(
        ...
        @Qualifier("filterChain") SecurityFilterChain filter) {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> createEmailTemplateConfiguration(
        ...
        try {
            ...
            EmailTemplateConfigurationDTO result = emailTemplateConfigurationService.save(emailTemplateConfigurationDTO);

            return ResponseEntity.created(new URI("/api/email-template-configurations/" + result.getId()))
                .headers(
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("Unable to save emailTemplateConfiguration, please fill in all fields.");
        }
    }
    ...
    public ResponseEntity<List<EmailTemplateConfigurationDTO>> getAllEmailTemplateConfigurations(
        ...
        if ("hotel-is-null".equals(filter)) {
            log.debug("REST request to get all EmailTemplateConfigurations where hotel is null");
            return new ResponseEntity<>(emailTemplateConfigurationService.findAllWhereHotelIsNull(), HttpStatus.OK);
        }
