...
/**
 * REST controller for managing {@link org.jhipster.projectintern.domain.Reservation}.
 */
@RestController
...
public class ReservationResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> createReservation(@RequestBody ReservationDTO reservationDTO) throws URISyntaxException {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("Unable to save Reservation, please fill in all fields.");
        }
    ...
    public ResponseEntity<List<ReservationDTO>> getAllReservations(
        ...
        if ("paiement-is-null".equals(filter)) {
            log.debug("REST request to get all Reservations where paiement is null");
            return new ResponseEntity<>(reservationService.findAllWherePaiementIsNull(), HttpStatus.OK);
        }
