...
import org.jhipster.projectintern.service.HotelAdministrateurService;
...
/**
 * REST controller for managing {@link org.jhipster.projectintern.domain.HotelAdministrateur}.
 */
@RestController
...
public class HotelAdministrateurResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> createHotelAdministrateur(@RequestBody HotelAdministrateurDTO hotelAdministrateurDTO)
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("Unable to save hotelAdministrateur, please fill in all fields.");
    ...
    @PostMapping("/associate-hotel-admin/{hotelid}/{adminid}")
    public ResponseEntity<?> associateHotelToAdmin(@PathVariable("hotelid") Long hotelId, @PathVariable("adminid") Long adminId) {
        return hotelAdministrateurService.associateHotelToAdmin(hotelId, adminId);
    }
