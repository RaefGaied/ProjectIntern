...
import org.jhipster.projectintern.service.AuthentificationConfigurationService;
...
public class AuthentificationConfigurationResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> createAuthentificationConfiguration(
        ...
        try {
         ...
         return ResponseEntity.created(new URI("/api/authentification-configurations/" + authentificationConfigurationDTO.getId()))
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("Unable to save AuthentificationConfiguration, please fill in all fields.");
    ...
    public ResponseEntity<List<AuthentificationConfigurationDTO>> getAllAuthentificationConfigurations(
        ...
        if ("hotel-is-null".equals(filter)) {
            log.debug("REST request to get all AuthentificationConfigurations where hotel is null");
            return new ResponseEntity<>(authentificationConfigurationService.findAllWhereHotelIsNull(), HttpStatus.OK);
        }
