...
import org.jhipster.projectintern.config.Constants;
import org.jhipster.projectintern.domain.User;
import org.jhipster.projectintern.repository.UserRepository;
import org.jhipster.projectintern.security.AuthoritiesConstants;
import org.jhipster.projectintern.service.MailService;
import org.jhipster.projectintern.service.UserService;
import org.jhipster.projectintern.service.dto.AdminUserDTO;
import org.jhipster.projectintern.web.rest.errors.BadRequestAlertException;
import org.jhipster.projectintern.web.rest.errors.EmailAlreadyUsedException;
import org.jhipster.projectintern.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link org.jhipster.projectintern.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    /**
     * {@code GET /user/role} : get the role of the currently logged-in user.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the role of the current user.
     */
    @GetMapping("/role")
    public ResponseEntity<List<String>> getUserRoles() {
        ...
        if (roles.isEmpty()) {
            roles.add("ROLE_USER"); // Default role if none are found
        }
