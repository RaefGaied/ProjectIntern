...
import org.jhipster.projectintern.service.ServiceService;
...
/**
 * REST controller for managing {@link org.jhipster.projectintern.domain.Service}.
 */
@RestController
...
public class ServiceResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<?> createService(@RequestBody ServiceDTO serviceDTO) throws URISyntaxException {
     ...
     try {
         ...
         return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
             .body("Unable to save Service, please fill in all fields.");
