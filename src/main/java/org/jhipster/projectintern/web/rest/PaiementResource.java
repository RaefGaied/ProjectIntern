...
import org.jhipster.projectintern.service.PaiementService;
...
/**
 * REST controller for managing {@link org.jhipster.projectintern.domain.Paiement}.
 */
@RestController
...
public class PaiementResource {
    ...
    @PostMapping("")
    public ResponseEntity<?> createPaiement(@RequestBody PaiementDTO paiementDTO) throws URISyntaxException {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body("Unable to save Payment, please fill in all fields.");
        }
    }
   ...
   /* @PostMapping("")
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<PaiementDTO>> getAllPaiements(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
    ...
    @PostMapping("/paiements/stripe/create-payment-intent")
    public ResponseEntity<PaymentIntent> createStripePaymentIntent(@RequestBody PaiementDTO paiementDTO) throws StripeException {
        PaymentIntent paymentIntent = paiementService.createPaymentIntent(paiementDTO);
