...
describe('Service Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Hotel query and add missing value', () => {
      ...
      const hotel: IHotel = { id: 15057 };
      service.hotel = hotel;

      const hotelCollection: IHotel[] = [{ id: 16307 }];
    ...
    it('Should call Partenaire query and add missing value', () => {
      const service: IService = { id: 456 };
      const partenaire: IPartenaire = { id: 32209 };
      service.partenaire = partenaire;

      const partenaireCollection: IPartenaire[] = [{ id: 8286 }];
    ...
    it('Should call Reservation query and add missing value', () => {
      const service: IService = { id: 456 };
      const reservation: IReservation = { id: 28226 };
      service.reservation = reservation;

      const reservationCollection: IReservation[] = [{ id: 31244 }];
    ...
    it('Should update editForm', () => {
      const service: IService = { id: 456 };
      const hotel: IHotel = { id: 12228 };
      service.hotel = hotel;
      const partenaire: IPartenaire = { id: 22354 };
      service.partenaire = partenaire;
      const reservation: IReservation = { id: 24861 };
      service.reservation = reservation;
