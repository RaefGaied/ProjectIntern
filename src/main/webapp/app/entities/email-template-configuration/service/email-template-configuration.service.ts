...
type RestOf<T extends IEmailTemplateConfiguration | NewEmailTemplateConfiguration> = Omit<T, 'datedeCreation' | 'datedeModification'> & {
...
export class EmailTemplateConfigurationService {
  ...
  >(emailTemplateConfiguration: T): RestOf<T> {
    return {
      ...
      datedeCreation: emailTemplateConfiguration.datedeCreation?.toJSON() ?? null,
      datedeModification: emailTemplateConfiguration.datedeModification?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restEmailTemplateConfiguration: RestEmailTemplateConfiguration): IEmailTemplateConfiguration {
    return {
      ...
      datedeCreation: restEmailTemplateConfiguration.datedeCreation ? dayjs(restEmailTemplateConfiguration.datedeCreation) : undefined,
      datedeModification: restEmailTemplateConfiguration.datedeModification
        ? dayjs(restEmailTemplateConfiguration.datedeModification)
        : undefined,
    };
  }
