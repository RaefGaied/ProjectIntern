...
describe('Paiement Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PaiementUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call reservation query and add missing value', () => {
      ...
      const reservation: IReservation = { id: 24475 };
      paiement.reservation = reservation;

      const reservationCollection: IReservation[] = [{ id: 6234 }];
    ...
    it('Should update editForm', () => {
      const paiement: IPaiement = { id: 456 };
      const reservation: IReservation = { id: 23258 };
      paiement.reservation = reservation;
